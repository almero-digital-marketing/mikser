...
module.exports = function (mikser) {
	...
	return (app) => {
		...
		if (mikser.config.browser) {
			...
			modules.push(jqueryModule);

			var browserifyCss = require.resolve('browserify-css');
			let browserifyCssModule = {};
			browserifyCssModule[browserifyCss] = { expose: 'browserify-css' };
			modules.push(browserifyCssModule);
